...
var num = 7;
const ageToVote = 18;      //ageToVote lower caamel cace 
let x =5;
let y = 7;
...
/* ARRAYS: */
const newEngLand = ["New Hamshire", " vermont", " Maine", "Massaschusetts", "Rhode Island", "connecticut" "New England"];
// index vallues          0              1          2             3               4            5                6
const grades = [91, 100, 88, 95, 75, 98, 100];
// index valuse  0   1    2   3   4   5    6 
